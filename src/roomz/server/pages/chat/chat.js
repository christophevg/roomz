            ...
            <v-card style="flex: 1; display: flex; flex-direction: column;">
              ...
              >
                <div
                  ...
                  :style="{'background-color': message.system ? 'rgba(var(--v-theme-primary), 0.08)' : 'rgba(var(--v-theme-primary), 0.1)'}"
                >
                  <div class="text-caption" :class="message.system ? 'text-primary' : 'text-high-emphasis'" style="margin-bottom: 4px;">
                  ...
                  <div v-if="message.system" class="text-body-2 font-italic text-primary">
                    {{ message.content }}
                  </div>
